...
| **C — Legal y privacidad (documentos + páginas públicas)** | Redactar e implementar en el producto: **Política de Tratamiento de Datos Personales** (responsable, finalidades, datos tratados, derechos del titular, canales, conservación, terceros — Ley 1581/2012), **Política de Privacidad**, **Términos y Condiciones**, **Política de Cookies** (si aplican cookies no estrictamente necesarias) y **avisos/consentimiento** correspondientes. Páginas públicas enlazadas desde auth/landing. Contenido en español neutro + inglés. *Recomendación de la auditoría: revisión con abogado cerca de beta comercial; en beta se entrega versión inicial sólida.* | P0-g, P0-h | — |
