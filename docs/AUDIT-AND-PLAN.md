...
| **D — Error monitoring + alertas** | Integrar un sistema de error tracking (Sentry u equivalente — nueva dependencia documentada) o, si se decide sin dependencia, un **ruteo centralizado de excepciones** a un backend de observabilidad con alertas. Complementa el audit trail operacional de R12 C2 (que registra operaciones; esto captura **excepciones no controladas y crashes**). Evitar depender de "el usuario me escribió por WhatsApp". | P0-f | A |
