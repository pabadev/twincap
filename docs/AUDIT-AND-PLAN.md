...
| **H — Beta QA, Definition of Beta y lanzamiento** | **H1** Prueba real de aislamiento manual con 2 usuarios en entorno desplegado (dashboard/movimientos/cuentas/créditos/ventas/clientes/catálogo A ≠ B). **H2** Redactar la "Definition of Beta" (checkbox P0/P1). **H3** Feature P1 de bajo costo/alto valor opcional para la beta: **Export CSV** (movimientos/ventas) — el resto (comparación mensual, presupuestos, flujo de caja, onboarding mejorado) queda como rollout según comportamiento real de la beta (Fase 2 del roadmap de la auditoría). **H4** Plan de lanzamiento (10–20 usuarios: 5 personal, 10 negocio, 5 POS; 30 días; métricas y entrevistas). | P1-c, P0-k, roadmap | A–G |
