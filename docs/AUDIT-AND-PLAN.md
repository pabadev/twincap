...
| **E — Feedback + soporte en producto** | **E1** Widget/botón "Enviar comentario / Reportar problema / Sugerir funcionalidad" que desemboca en email/DB (sin construir un sistema complejo). **E2** Canal de soporte estructurado (página "Ayuda" o correo de contacto configurado). | P0-i, P0-j | — |
