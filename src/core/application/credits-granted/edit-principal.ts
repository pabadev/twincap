 ...
 * on the version read inside the tx: a concurrent mutation (new abono, balance
 * edit, another principal edit) bumps it and forces a driver retry where all
 * guards re-evaluate against fresh state.
 */
