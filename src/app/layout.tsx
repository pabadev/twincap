...
export default async function RootLayout({
  ...
  // Per-request nonce generated by the proxy (see src/proxy.ts). Matching the
  // script-src 'nonce-…' in the CSP, it lets the inline theme script below run
  // while all other inline scripts stay blocked. Reading a request-time header
  // keeps the layout dynamic — the root layout already reads cookies via
  // getLocale(), so no rendering behavior changes.
