        ...
        <>
          ...
          <div className="mb-4 sm:hidden">
            <button
              ...
              aria-controls="credits-received-filters"
          ...
          {filtersOpen && (
            <div id="credits-received-filters" className="mb-6 sm:hidden">
              <div className="grid grid-cols-1 gap-3">
                <div>
                  ...
                  <input
                    id="credits-received-filter-date-from-mobile"
                    type="date"
                    value={dateFrom}
                ...
                <div>
                  ...
                  <input
                    id="credits-received-filter-date-to-mobile"
                    type="date"
                    value={dateTo}
                ...
                <div>
                  ...
                  <Select
                    id="credits-received-filter-status-mobile"
                    options={[
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {filtered.map((credit) => {
              ...
              return (
                <div
                  key={credit.id}
                  className={`flex h-full flex-col overflow-hidden rounded-lg border border-surface-border bg-surface-card dark:border-zinc-700 dark:bg-zinc-900 ${isPaid ? "opacity-60" : ""}`}
                >
