...
export function PayablesList({
  ...
  const filtered = payables.filter((payable) => {
    if (payable.dueDate) {
      if (dateFrom && new Date(payable.dueDate).getTime() < new Date(dateFrom).getTime())
        return false;
      if (
        dateTo &&
        new Date(payable.dueDate).getTime() > new Date(dateTo + "T23:59:59.999Z").getTime()
      )
        return false;
    }
        ...
        <>
          ...
          <div className="mb-4 sm:hidden">
            <button
              ...
              aria-controls="payables-filters"
          ...
          {filtersOpen && (
            <div id="payables-filters" className="mb-6 sm:hidden">
              <div className="grid grid-cols-1 gap-3">
                <div>
                  ...
                  <input
                    id="payables-filter-due-date-from-mobile"
                    type="date"
                    value={dateFrom}
                ...
                <div>
                  ...
                  <input
                    id="payables-filter-due-date-to-mobile"
                    type="date"
                    value={dateTo}
                ...
                <div>
                  ...
                  <Select
                    id="payables-filter-status-mobile"
                    options={[
              ...
              return (
                ...
                >
                  {/* Product decision 2026-09-21: cards everywhere — the
                      ...
                      (identity + chevron, label/value rows, bordered footer). */}
                  <div
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      <div className="min-w-0 truncate font-medium text-zinc-900 dark:text-white">
                    ...
                    <dl className="mt-2 space-y-2">
                      ...
                      {payable.dueDate && (
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <dd className="text-right text-xs text-zinc-600 dark:text-zinc-400">
                            {formatDate(payable.dueDate, locale)}
                          </dd>
                        </div>
                      )}
                      {payable.note && (
                        ...
                        {pending > 0 && (
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              setShowAbonoFormId(
                                showAbonoFormId === payable.id ? null : payable.id,
                              );
